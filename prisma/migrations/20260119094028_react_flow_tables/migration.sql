...
-- CreateIndex
CREATE UNIQUE INDEX "Connection_fromNodeId_fromOutput_key" ON "Connection"("fromNodeId", "fromOutput");

-- CreateIndex
CREATE UNIQUE INDEX "Connection_toNodeId_toInput_key" ON "Connection"("toNodeId", "toInput");
